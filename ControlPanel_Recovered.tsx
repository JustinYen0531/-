...
import {
    ...
    Cpu, Cloud, Snowflake, Share2, Radiation, Ghost, Scan
} from 'lucide-react';
import {
    GameState, Unit, UnitType,
    MineType, TargetMode
} from '../types';
import {
                                            ...
                                            <div className="flex gap-2 justify-center items-start w-full px-4 py-2 overflow-visible">
                                                    ...
                                                    >
                                                        ...
                                                        <span className="text-xs">{(() => {
                                                            ...
                                                            const isRB3 = u?.type === UnitType.RANGER &&
                                                                gameState.players[u.owner].evolutionLevels[UnitType.RANGER].b >= 3 &&
                                                                gameState.players[u.owner].evolutionLevels[UnitType.RANGER].bVariant === 1;
                                                            return isRB3 ? '嚙?Zap size={12} className=" text-yellow-400\ />嚙踝蕭?嚙?Zap size={12} className=" text-yellow-400\ />嚙踝蕭?' : t('move');
                                                        })()}</span>
                                                    </button>
                                                    ...
                                                    if (canPlaceTower) {
                                                        buttons.push(
                                                            <div key="place_tower" className="flex flex-col items-center gap-1">
                                                                <button onClick={() => handlePlaceTowerAction(unit, unit.r, unit.c)} className="w-[82px] h-[74px] rounded flex flex-col items-center justify-center gap-1 transition-all relative font-bold border-2 bg-orange-900/40 hover:bg-orange-800/60 border-orange-800/50 text-orange-100/70 hover:border-orange-400 hover:text-white">
                                                                    ...
                                                                    <Radio size={28} /> <span className="text-xs">嚙?Zap size={12} className=" text-yellow-400\ />嚙踝蕭嚙踝蕭嚙?Zap size={12} className=" text-yellow-400\ />?/span>
                                                                </button>
                                                                <div className="bg-slate-800 rounded px-2 py-1 flex items-center gap-1 text-xs font-bold text-white">??{helpers.getDisplayCost(unit, 8, gameState, 'place_tower')}</div>
                                                            </div>
                                                        );
                                                    }
                                                    if (canPlaceFactory) {
                                                        ...
                                                        buttons.push(
                                                            <div key="place_factory" className="flex flex-col items-center gap-1">
                                                                ...
                                                                >
                                                                    ...
                                                                    <FlaskConical size={28} /> <span className="text-xs">嚙?Zap size={12} className=" text-yellow-400\ />嚙踝蕭嚙踝蕭嚙?Zap size={12} className=" text-yellow-400\ />嚙踝蕭?</span>
                                                                </button>
                                                                <div className="bg-slate-800 rounded px-2 py-1 flex items-center gap-1 text-xs font-bold text-white">??{helpers.getDisplayCost(unit, (mkrB === 3 && player.evolutionLevels[UnitType.MAKER].bVariant === 2) ? 4 : 6, gameState, 'place_factory')}</div>
                                                            </div>
                                                        );
                                                    }
                                                    if (canPlaceHub) {
                                                        buttons.push(
                                                            <div key="place_hub" className="flex flex-col items-center gap-1">
                                                                <button onClick={() => handlePlaceHubAction(unit, unit.r, unit.c)} className="w-[82px] h-[74px] rounded flex flex-col items-center justify-center gap-1 transition-all relative font-bold border-2 bg-indigo-900/40 hover:bg-indigo-800/60 border-indigo-800/50 text-indigo-100/70">
                                                                    ...
                                                                    <Cpu size={28} /> <span className="text-xs">嚙?Zap size={12} className=" text-yellow-400\ />嚙踝蕭嚙踝蕭嚙?Zap size={12} className=" text-yellow-400\ />嚙踝蕭?</span>
                                                                </button>
                                                        ...
                                                        buttons.push(
                                                            <div key="custom_dismantle" className="flex flex-col items-center gap-1">
                                                                <button onClick={() => handleDisarmAction(unit, unit.r, unit.c)} className="w-[82px] h-[74px] rounded flex flex-col items-center justify-center gap-1 transition-all relative font-bold border-2 bg-pink-900/40 hover:bg-pink-800/60 border-pink-800/50 text-pink-100/70 hover:border-pink-400 hover:text-white">
                                                                    ...
                                                                    <Unlock size={28} />
                                                                    <span className="text-xs">?嚙踝蕭嚙踝蕭嚙?Zap size={12} className=" text-yellow-400\ />嚙踝蕭?</span>
                                                                </button>
                                                    ...
                                                    if (unit.type === UnitType.GENERAL) {
                                                        ...
                                                        if (!unit.hasFlag || (genLevelA >= 3 && genVariantA === 1) || (gameState as any).isGodMode) {
                                                            buttons.push(
                                                                <div key="attack" className="flex flex-col items-center gap-1">
                                                                    ...
                                                                    <div className="bg-slate-800 rounded px-2 py-1 flex items-center gap-1 text-xs font-bold text-white">
                                                                        <span className="text-yellow-400">??/span>
                                                                        <span>{helpers.getDisplayCost(unit, 8, gameState, 'attack')}</span>
                                                                    </div>
                                                                </div>
                                                            );
                                                        }
                                                        ...
                                                        buttons.push(
                                                            <div key="scan" className="flex flex-col items-center gap-1">
                                                                ...
                                                                <div className="bg-slate-800 rounded px-2 py-1 flex items-center gap-1 text-xs font-bold text-white">??{helpers.getDisplayCost(unit, swpLevelA >= 1 ? 5 : 8, gameState, 'scan')}</div>
                                                            </div>
                                                        );

                                                        // Path B: Sensor Scan
                                                        if (swpLevelB >= 1) {
                                                            const cost = swpLevelB >= 3 ? 3 : (swpLevelB >= 2 ? 4 : 5);
                                                            const variantB = player.evolutionLevels[UnitType.MINESWEEPER].bVariant;
                                                            const finalCost = (swpLevelB === 3 && variantB === 2) ? 6 : cost;

                                                            buttons.push(
                                                                <div key="sensor_scan" className="flex flex-col items-center gap-1">
                                                                    <button
                                                                        onClick={() => handleSetTargetMode('sensor_scan')}
                                                                        className={`w-[82px] h-[74px] rounded flex flex-col items-center justify-center gap-1 transition-all relative font-bold border-2 ${targetMode === 'sensor_scan' && !endTurnConfirm ? 'bg-cyan-600 shadow-lg shadow-cyan-500/50 scale-105 border-cyan-400 text-white' : 'bg-cyan-900/40 hover:bg-cyan-800/60 border-cyan-800/50 text-cyan-100/70'}`}
                                                                    >
                                                                    ...
                                                                    <div className="bg-slate-800 rounded px-2 py-1 flex items-center gap-1 text-xs font-bold text-white">??{helpers.getDisplayCost(unit, finalCost, gameState, 'sensor_scan')}</div>
                                                                </div>
                                                            );
                                                        }
                                                            ...
                                                            buttons.push(
                                                                <div key="pickup_mine" className="flex flex-col items-center gap-1">
                                                                    <button onClick={() => { handleRangerAction('pickup'); setEndTurnConfirm(false); }} className="w-[82px] h-[74px] rounded flex flex-col items-center justify-center gap-1 transition-all relative font-bold border-2 bg-yellow-900/40 hover:bg-yellow-800/60 border-yellow-800/50 text-yellow-100/70">
                                                                        ...
                                                                        <Bomb size={28} /> <span className="text-xs">?嚙踝蕭??嚙踝蕭嚙踝蕭</span>
                                                                    </button>
                                                            ...
                                                            buttons.push(
                                                                <div key="ghost_steps" className="flex flex-col items-center gap-1">
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <Ghost size={28} />
                                                                        <span className="text-xs">{unit.status.isStealthed ? '?嚙踝蕭?' : '嚙?Zap size={12} className=" text-yellow-400\ />嚙踝蕭?嚙?Zap size={12} className=" text-yellow-400\ />嚙踝蕭?'}</span>
                                                                    </button>
                                                                ...
                                                                buttons.push(
                                                                    <div key="throw_mine" className="flex flex-col items-center gap-1">
                                                                        <button onClick={() => handleSetTargetMode('throw_mine')} className={`w-[82px] h-[74px] rounded flex flex-col items-center justify-center gap-1 transition-all relative font-bold border-2 ${targetMode === 'throw_mine' && !endTurnConfirm
                                                                            ...
                                                                            <Bomb size={28} /> <span className="text-xs">?嚙踝蕭嚙踝蕭?嚙踝蕭嚙踝蕭</span>
                                                                        </button>
                                                                        <div className="bg-slate-800 rounded px-2 py-1 flex items-center gap-1 text-xs font-bold text-white">??{helpers.getDisplayCost(unit, 4, gameState, 'throw_mine')}</div>
                                                                    </div>
                                                                );
                                                            }
                                                            buttons.push(
                                                        ...
                                                        buttons.push(
                                                            <div key="disarm" className="flex flex-col items-center gap-1">
                                                                ...
                                                                <div className="bg-slate-800 rounded px-2 py-1 flex items-center gap-1 text-xs font-bold text-white">??{helpers.getDisplayCost(unit, 3, gameState, 'disarm')}</div>
                                                            </div>
                                                        );
                                                    }
                                                        ...
                                                        buttons.push(
                                                            <div key="teleport" className="flex flex-col items-center gap-1">
                                                                <button onClick={() => { handleTeleportToHubAction(unit); setEndTurnConfirm(false); }} className={`w-[82px] h-[74px] rounded flex flex-col items-center justify-center gap-1 transition-all relative font-bold border-2 ${targetMode === 'teleport' && !endTurnConfirm ? 'bg-amber-600 border-amber-400 scale-105 shadow-lg shadow-amber-500/50 text-white' : 'bg-amber-500/20 hover:bg-amber-500/40 border-amber-500/50 text-amber-100/90 hover:border-amber-400 hover:text-white'}`}>
                                                                    ...
                                                                    <Zap size={28} /> <span className="text-xs">?嚙踝蕭嚙?Zap size={12} className=" text-yellow-400\ />?/span>
                                                                </button>
                                                ...
                                                <div className="flex flex-col items-center gap-1">
                                                    ...
                                                    >
                                                        ...
                                                        <CheckCircle size={28} />
                                                        <span className="text-xs">{endTurnConfirm ? '嚙?Zap size={12} className=" text-yellow-400\ />嚙踝蕭?' : t('end_turn')}</span>
                                                    </button>
                                                                    ...
                                                                    <div key={`evolve_a_${v.id}`} className="flex flex-col items-center gap-1">
                                                                        <button onClick={() => actions.handleEvolve(unit.type, 'a', v.id)} className={`relative w-[82px] h-[74px] rounded flex flex-col items-center justify-center ${v.color} font-bold border-2 text-white overflow-hidden transition-all group active:scale-95 leading-tight`}>
                                                                            ...
                                                                            <div className="flex flex-col items-center">
                                                                                <span className="text-[9px] opacity-80 font-medium">嚙?Zap size={12} className=" text-yellow-400\ />嚙踝蕭?A</span>
                                                                                <span className="text-[10px] tracking-tighter">LV2?嚙緹v.label}</span>
                                                                            </div>
                                                                        </button>
                                                                        <div className="bg-slate-800 rounded px-1.5 py-0.5 flex items-center gap-1 text-[10px] font-bold text-white">??{helpers.getDisplayCost(unit, EVOLUTION_COSTS[2], gameState, 'evolve')}</div>
                                                                    </div>
                                                                );
                                                            });
                                                        } else {
                                                            result.push(
                                                                <div key="evolve_a" className="flex flex-col items-center gap-1">
                                                                    <button onClick={() => actions.handleEvolve(unit.type, 'a')} className="relative w-[82px] h-[74px] rounded flex flex-col items-center justify-center bg-blue-600 hover:bg-blue-500 font-bold border-2 border-blue-400 shadow-[0_0_20px_rgba(37,99,235,0.6)] text-white overflow-hidden transition-all group active:scale-95 leading-tight">
                                                                        <Dna size={28} className="mb-0.5 drop-shadow-md group-hover:scale-110 transition-transform" />
                                                                        <div className="flex flex-col items-center">
                                                                            <span className="text-[10px] opacity-80 font-medium">嚙?Zap size={12} className=" text-yellow-400\ />嚙踝蕭?A</span>
                                                                            <span className="text-xs tracking-tighter">LV{pLevels.a}?嚙緹pLevels.a + 1}</span>
                                                                        </div>
                                                                    </button>
                                                                    <div className="bg-slate-800 rounded px-2 py-1 flex items-center gap-1 text-xs font-bold text-white">??{helpers.getDisplayCost(unit, EVOLUTION_COSTS[pLevels.a as keyof typeof EVOLUTION_COSTS], gameState, 'evolve')}</div>
                                                                </div>
                                                            );
                                                        }
                                                    }
                                                                ...
                                                                result.push(
                                                                    <div key={`evolve_b_${v.id}`} className="flex flex-col items-center gap-1">
                                                                        <button onClick={() => actions.handleEvolve(unit.type, 'b', v.id)} className={`relative w-[82px] h-[74px] rounded flex flex-col items-center justify-center ${v.color} font-bold border-2 text-white overflow-hidden transition-all group active:scale-95 leading-tight`}>
                                                                            <Dna size={28} className="mb-0.5 drop-shadow-md group-hover:scale-110 transition-transform" />
                                                                            <div className="flex flex-col items-center">
                                                                                <span className="text-[9px] opacity-80 font-medium">嚙?Zap size={12} className=" text-yellow-400\ />嚙踝蕭?B</span>
                                                                                <span className="text-[10px] tracking-tighter">LV2?嚙緹v.label}</span>
                                                                            </div>
                                                                        </button>
                                                                        <div className="bg-slate-800 rounded px-1.5 py-0.5 flex items-center gap-1 text-[10px] font-bold text-white">??{helpers.getDisplayCost(unit, EVOLUTION_COSTS[2], gameState, 'evolve')}</div>
                                                            ...
                                                            result.push(
                                                                <div key="evolve_b" className="flex flex-col items-center gap-1">
                                                                    <button onClick={() => actions.handleEvolve(unit.type, 'b')} className="relative w-[82px] h-[74px] rounded flex flex-col items-center justify-center bg-orange-600 hover:bg-orange-500 font-bold border-2 border-orange-400 shadow-[0_0_20px_rgba(249,115,22,0.6)] text-white overflow-hidden transition-all group active:scale-95 leading-tight">
                                                                        <Dna size={28} className="mb-0.5 drop-shadow-md group-hover:scale-110 transition-transform" />
                                                                        <div className="flex flex-col items-center">
                                                                            <span className="text-[10px] opacity-80 font-medium">嚙?Zap size={12} className=" text-yellow-400\ />嚙踝蕭?B</span>
                                                                            <span className="text-xs tracking-tighter">LV{pLevels.b}?嚙緹pLevels.b + 1}</span>
                                                                        </div>
                                                                    </button>
                                                                    <div className="bg-slate-800 rounded px-2 py-1 flex items-center gap-1 text-xs font-bold text-white">??{helpers.getDisplayCost(unit, EVOLUTION_COSTS[pLevels.b as keyof typeof EVOLUTION_COSTS], gameState, 'evolve')}</div>
                                                                </div>
                                                            );
                                                        }
                                                    }
                                                ...
                                                {(() => {
                                                    ...
                                                    return (
                                                        <>
                                                            ...
                                                            {/* Skip Turn - switch to enemy turn, costs escalating energy */}
                                                            <button
                                                            ...
                                                            >
                                                                ...
                                                                <span className="ml-2 flex items-center gap-1 bg-slate-800/60 px-2 py-0.5 rounded text-xs">
