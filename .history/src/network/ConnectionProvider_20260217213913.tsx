...
const createPeerInstance = (peerId: string): Peer => {
...
export const ConnectionProvider: React.FC<React.PropsWithChildren> = ({ children }) => {
    ...
    const openPeer = useCallback((preferredId?: string): Promise<string> => {
        ...
        return new Promise<string>((resolve, reject) => {
            let settled = false;
            const peer = createPeerInstance(requestedId);
    ...
    }, [attachConnection, clearReconnectTimer, localPeerId, openPeer, scheduleReconnect]);
