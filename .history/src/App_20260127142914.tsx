...
import {
    ...
    checkEnergyCap as engineCheckEnergyCap, MineTriggerResult
} from './gameEngine';
import {
...
import {
    ...
    Dna, Unlock, X, Globe, Star, Hand, ChevronLeft, ChevronRight, DoorOpen, FlaskConical, Radio, ShieldAlert, RefreshCw, Ghost
} from './icons';
    ...
    const attemptMove = (unitId: string, r: number, c: number, cost: number) => {
        ...
        if (proximityNukeIndex !== -1) {
            ...
            if (directContactMineIndex !== -1) {
                ...
                mineToTrigger = currentState.mines[activeMineIndex];
                if (mineToTrigger.type === MineType.NUKE) nukeMineTriggered = true;
            }
        }
