...
import { AIDecisionInfo, AIDifficulty } from './ai/types';
...
export default function App() {
    ...
    const clearMissMarksImmediatelyAt = useCallback((targetR: number, targetC: number) => {
        setGameState(prev => {
    ...
    */
    ...
    useGameAI({
        ...
        actions: {
            ...
            handleMinePlacement: playerActions.handleMinePlacement,
            handleDisarm: playerActions.handleDisarm,
