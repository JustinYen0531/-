...
export default function App() {
    ...
    */
    ...
    }, [gameStateRef, targetMode, PLACEMENT_MINE_LIMIT, setGameState, addLog, handleUnitClick, playerActions, selectedMineType, selectedMineId, setSelectedMineId, setTargetMode]);
