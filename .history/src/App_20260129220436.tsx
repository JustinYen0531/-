...
export default function App() {
    ...
    const playerActions = usePlayerActions(gameState, setGameState, addLog, addVFX, setShowEvolutionTree, getUnit);
    useGameLoop(gameState, setGameState, playerActions, getUnit, addLog, setShowEvolutionTree);
    useGameAI(gameState, setGameState, playerActions, addLog);
    ...
    const getActionButtonIndex = (actionType: string, unit: Unit | null | undefined): number => {
        ...
        if (unit.type === UnitType.GENERAL) {
            ...
            if (swpB >= 1) actions.push('sensor_scan');
