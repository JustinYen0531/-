                                                                ...
                                                                <>
                                                                    ...
                                                                    <div className="flex-1 relative h-full">
                                                                        {(() => {
                                                                            ...
                                                                            return (
                                                                                <div onClick={() => setFlippedCardId(isFlipped ? null : cardId)}
                                                                                    className={`absolute inset-0 z-10 p-2 rounded border flex flex-col justify-center cursor-pointer transition-all duration-300 ${isFlipped ? 'scale-110 !h-auto min-h-[140px] !z-50 bg-slate-900 border-2 border-orange-500 shadow-xl shadow-orange-900/20' : 'h-full bg-slate-900 border-2 border-orange-500/80 text-orange-100 shadow-[0_0_12px_rgba(249,115,22,0.25)]'}`}>
                                                                                    {isFlipped ? (
                                                                        ...
                                                                        {[2, 3].map((idx) => {
                                                                            ...
                                                                            return (
                                                                                <div key={idx} className="relative h-[46px]">
                                                                                    ...
                                                                                    }} className={`absolute inset-0 z-10 p-2 rounded border flex flex-col justify-center cursor-pointer transition-all duration-300 ${isFlipped ? 'scale-110 !h-auto min-h-[140px] !z-50 bg-slate-900 border-2 border-orange-500 shadow-xl shadow-orange-900/20' : `h-full ${isUnlocked ? 'bg-slate-900 border-2 border-orange-500/80 text-orange-100 shadow-[0_0_12px_rgba(249,115,22,0.25)]' : isOtherVariantSelected ? 'bg-transparent border-gray-800 text-gray-700 opacity-20 grayscale pointer-events-none' : 'bg-gray-800/40 border-gray-600/50 text-gray-500 hover:border-gray-500'}`}`}>
                                                                                        {isFlipped ? (
