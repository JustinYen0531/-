    ...
    if (view === 'lobby') {
        return (
            <div className="flex flex-col items-center justify-center h-full bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950 p-4 relative w-full absolute inset-0 z-50 overflow-hidden">
                ...
                <div className="relative z-10 text-center space-y-3 pt-20">
                    ...
                    <div className="relative z-10 mt-10 flex w-full max-w-5xl flex-col items-center gap-6">
                        ...
                        {latestDeveloperLog && (
                            <button
                                ...
                                className="w-full max-w-lg rounded-xl border border-white/10 bg-white/5 px-4 py-2.5 text-center shadow-lg transition-all hover:bg-white/10 hover:scale-[1.01]"
                            >
