                    ...
                    return (
                        <div key={`${r}-${c}`} className="relative">
                            <GridCell
                                ...
                                selectedUnitLevelB={selectedUnit && selectedUnitOwner ? selectedUnitOwner.evolutionLevels[selectedUnit.type].b : 0}
                            />
                            {sResult && (
                                <div className="absolute inset-0 pointer-events-none z-30 flex items-center justify-center">
                                    <div className="bg-cyan-500/80 text-white font-black text-2xl drop-shadow-[0_0_5px_rgba(0,0,0,0.8)] rounded-full w-8 h-8 flex items-center justify-center animate-bounce-short">
                                        {sResult.count}
                                    </div>
                                </div>
                            )}
