                        ...
                        return (
                            <div key={u.id} className="flex flex-col items-center gap-1">
                                <button
                                    ...
                                    draggable={!u.isDead && (isPlacement || (gameState.phase === 'action' && !gameState.activeUnitId && !gameState.selectedUnitId))}
                                    ...
                                    className={`
                                        ...
                                        ${!u.isDead && (isPlacement || (gameState.phase === 'action' && !gameState.activeUnitId && !gameState.selectedUnitId)) ? 'cursor-grab active:cursor-grabbing' : ''}
