...
const TUTORIAL_STEPS: TutorialStep[] = [
    {
        ...
        titleZh: '歡迎來到地雷棋',
        contentEn: `Mine Chess is a 2-player strategic turn-based game that combines classic Minesweeper mechanics with Capture-The-Flag gameplay.
...
時間壓力創造緊張感。快速思考，但別慌張！`,
    ...
    },
    {
        ...
        titleEn: 'Capture The Flag',
        titleZh: '奪旗目標',
        contentEn: `The victory condition: Capture enemy flag & bring it to YOUR base!
