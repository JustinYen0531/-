      ...
      return (
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-20 overflow-visible">
          ...
          <div className={`relative w-8 h-8 flex items-center justify-center`}>
            ...
            {/* Duration Display (Turns Left Badge) */}
            {(building.duration ?? 0) > 0 && (
              <div className={`absolute -top-3 -right-3 w-[18px] h-[18px] rounded-full bg-slate-900/90 border-2 ${building.owner === PlayerID.P1 ? 'border-cyan-400 shadow-[0_0_8px_rgba(34,211,238,0.5)]' : 'border-red-400 shadow-[0_0_8px_rgba(239,68,68,0.5)]'} flex items-center justify-center text-[10px] font-black text-white z-30`}>
                {building.duration}
              </div>
            )}
          </div>
