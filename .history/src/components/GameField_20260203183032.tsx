                ...
                {gameState.cells.map((row, r) => row.map((cell, c) => {
                    ...
                    return (
                        <div key={`${r}-${c}`} className="relative">
                            ...
                            />
                            {sResult && (
                                <div className="absolute top-0 right-0 pointer-events-none z-30 p-0.5">
                                    <div className="bg-cyan-500/90 text-white font-black text-sm drop-shadow-[0_0_3px_rgba(0,0,0,0.8)] rounded-sm w-5 h-5 flex items-center justify-center animate-pulse border border-cyan-300/50">
                                        {sResult.count}
                                    </div>
                                </div>
                            )}
