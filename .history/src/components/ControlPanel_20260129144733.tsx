                                ...
                                <div className="flex-1 flex flex-col justify-center w-full">
                                    <div className="w-full flex flex-col justify-center gap-2 items-center relative min-w-[150px]">
                                        {isThinking ? (
                                            ...
                                            <div className="flex gap-1.5 justify-center items-stretch w-full overflow-x-auto scrollbar-hide px-2">
                                                {/* All buttons in one row */}
                                                <div className="flex flex-col items-center gap-1">
                                                    <button
                                                        onClick={() => handleSetTargetMode('move')}
                                                        className={`flex-1 min-w-[68px] max-w-[85px] py-1.5 px-1 rounded flex flex-col items-center justify-center gap-0.5 transition-all relative font-bold border-2 ${targetMode === 'move' && !endTurnConfirm
                                                    ...
                                                    >
                                                        <div className="absolute top-0.5 left-1 text-[10px] font-black text-white/90">{helpers.getActionButtonIndex('move', helpers.getUnit(gameState.selectedUnitId))}</div>
                                                        <ArrowRight size={24} />
                                                        <span className="text-[10px] whitespace-nowrap">{t('move')}</span>
                                                    </button>
                                                        ...
                                                        buttons.push(
                                                            <div key="place_factory" className="flex flex-col items-center gap-1">
                                                                <button
                                                                    ...
                                                                    className={`w-[74px] h-[74px] p-1 rounded flex flex-col items-center justify-center gap-1 transition-all relative font-bold border-2 ${factoryButtonFlash
                                                            ...
                                                            buttons.push(
                                                                <div key="attack" className="flex flex-col items-center gap-1">
                                                                    <button
                                                                        ...
                                                                        className={`w-[74px] h-[74px] p-1 rounded flex flex-col items-center justify-center gap-1 transition-all relative font-bold border-2 ${targetMode === 'attack' && !endTurnConfirm
                                                        ...
                                                        buttons.push(
                                                            <div key="place_mine_group" className="flex flex-col items-center gap-1 relative">
                                                                ...
                                                                <button
                                                                    ...
                                                                    className={`w-[74px] h-[74px] p-1 rounded flex flex-col items-center justify-center gap-1 transition-all relative font-bold border-2 ${targetMode === 'place_mine' && !endTurnConfirm
                                                        ...
                                                        if (!unit.carriedMine && mineInRange) {
                                                            buttons.push(
                                                                <div key="pickup_mine" className="flex flex-col items-center gap-1">
                                                                    <button onClick={() => { handleRangerAction('pickup'); setEndTurnConfirm(false); }} className="w-[74px] h-[74px] p-1 rounded flex flex-col items-center justify-center gap-1 transition-all relative font-bold border-2 bg-yellow-900/40 hover:bg-yellow-800/60 border-yellow-800/50 text-yellow-100/70">
                                                        ...
                                                        if (unit.carriedMine) {
                                                            buttons.push(
                                                                <div key="throw_mine" className="flex flex-col items-center gap-1">
                                                                    <button onClick={() => handleSetTargetMode('throw_mine')} className={`w-[74px] h-[74px] p-1 rounded flex flex-col items-center justify-center gap-1 transition-all relative font-bold border-2 ${targetMode === 'throw_mine' && !endTurnConfirm
                                                            ...
                                                            buttons.push(
                                                                <div key="drop_mine" className="flex flex-col items-center gap-1">
                                                                    <button onClick={() => { handleRangerAction('drop'); setEndTurnConfirm(false); }} className="w-[74px] h-[74px] p-1 rounded flex flex-col items-center justify-center gap-1 transition-all relative font-bold border-2 bg-yellow-900/40 hover:bg-yellow-800/60 border-yellow-800/50 text-yellow-100/70">
                                                        ...
                                                        if (!unit.hasFlag && isAtFlag) {
                                                            buttons.push(
                                                                <div key="pickup_flag" className="flex flex-col items-center gap-1">
                                                                    <button onClick={() => { actions.handlePickupFlag(); setEndTurnConfirm(false); }} className="w-[74px] h-[74px] p-1 rounded flex flex-col items-center justify-center gap-1 transition-all relative font-bold border-2 bg-yellow-900/40 hover:bg-yellow-800/60 border-yellow-800/50 text-yellow-100/70">
                                                        ...
                                                        if (unit.hasFlag) {
                                                            buttons.push(
                                                                <div key="drop_flag" className="flex flex-col items-center gap-1">
                                                                    <button onClick={() => { actions.handleDropFlag(); setEndTurnConfirm(false); }} className="w-[74px] h-[74px] p-1 rounded flex flex-col items-center justify-center gap-1 transition-all relative font-bold border-2 bg-yellow-900/40 hover:bg-yellow-800/60 border-yellow-800/50 text-yellow-100/70">
                                                ...
                                                <div className="flex flex-col items-center gap-1">
                                                    <button
                                                        ...
                                                        className={`flex-1 min-w-[68px] max-w-[85px] py-1.5 px-1 rounded flex flex-col items-center justify-center gap-0.5 transition-all relative font-bold border-2 ${endTurnConfirm
                                                            ? 'bg-slate-800 hover:bg-slate-700 border-slate-400 scale-105 shadow-lg shadow-slate-400/50'
                                                            : 'bg-slate-700 hover:bg-slate-600 border-slate-600'
                                                            } text-slate-200`}
                                                    >
                                                        <div className="absolute top-0.5 left-1 text-[10px] font-black text-white/90">{helpers.getActionButtonIndex('end_turn', helpers.getUnit(gameState.selectedUnitId))}</div>
                                                        <CheckCircle size={24} />
                                                        <span className="text-[10px] whitespace-nowrap">{endTurnConfirm ? '確認' : t('end_turn')}</span>
                                                    </button>
                                                </div>
                                                        ...
                                                        if (pLevels.a === 2) {
                                                            ...
                                                            variants.forEach(v => {
                                                                result.push(
                                                                    <div key={`evolve_a_${v.id}`} className="flex flex-col items-center gap-1">
                                                                        <button onClick={() => actions.handleEvolve(unit.type, 'a', v.id)} className={`relative min-w-[68px] max-w-[85px] py-1.5 px-1 rounded flex flex-col items-center justify-center ${v.color} font-bold border-2 text-white overflow-hidden transition-all group active:scale-95 leading-tight`}>
                                                                            <Dna size={20} className="mb-0.5 drop-shadow-md group-hover:scale-110 transition-transform" />
                                                                            <div className="flex flex-col items-center">
                                                                                <span className="text-[8px] opacity-80 font-medium">路徑A</span>
                                                                                <span className="text-[9px] tracking-tighter">LV2→{v.label}</span>
                                                                            </div>
                                                                        </button>
                                                            ...
                                                            result.push(
                                                                <div key="evolve_a" className="flex flex-col items-center gap-1">
                                                                    <button onClick={() => actions.handleEvolve(unit.type, 'a')} className="relative min-w-[68px] max-w-[85px] py-1.5 px-1 rounded flex flex-col items-center justify-center bg-blue-600 hover:bg-blue-500 font-bold border-2 border-blue-400 shadow-[0_0_20px_rgba(37,99,235,0.6)] text-white overflow-hidden transition-all group active:scale-95 leading-tight">
                                                                        <Dna size={20} className="mb-0.5 drop-shadow-md group-hover:scale-110 transition-transform" />
                                                                        <div className="flex flex-col items-center">
                                                                            <span className="text-[8px] opacity-80 font-medium">路徑A</span>
                                                                            <span className="text-[10px] tracking-tighter">LV{pLevels.a}→{pLevels.a + 1}</span>
                                                                        </div>
                                                                    </button>
                                                        ...
                                                        if (pLevels.b === 2) {
                                                            ...
                                                            variants.forEach(v => {
                                                                result.push(
                                                                    <div key={`evolve_b_${v.id}`} className="flex flex-col items-center gap-1">
                                                                        <button onClick={() => actions.handleEvolve(unit.type, 'b', v.id)} className={`relative min-w-[68px] max-w-[85px] py-1.5 px-1 rounded flex flex-col items-center justify-center ${v.color} font-bold border-2 text-white overflow-hidden transition-all group active:scale-95 leading-tight`}>
                                                                            <Dna size={20} className="mb-0.5 drop-shadow-md group-hover:scale-110 transition-transform" />
                                                                            <div className="flex flex-col items-center">
                                                                                <span className="text-[8px] opacity-80 font-medium">路徑B</span>
                                                                                <span className="text-[9px] tracking-tighter">LV2→{v.label}</span>
                                                                            </div>
                                                                        </button>
                                                                        <div className="bg-slate-800 rounded px-1.5 py-0.5 flex items-center gap-1 text-[10px] font-bold text-white">⚡ {EVOLUTION_COSTS[2]}</div>
                                                            ...
                                                            result.push(
                                                                <div key="evolve_b" className="flex flex-col items-center gap-1">
                                                                    <button onClick={() => actions.handleEvolve(unit.type, 'b')} className="relative min-w-[68px] max-w-[85px] py-1.5 px-1 rounded flex flex-col items-center justify-center bg-orange-600 hover:bg-orange-500 font-bold border-2 border-orange-400 shadow-[0_0_20px_rgba(249,115,22,0.6)] text-white overflow-hidden transition-all group active:scale-95 leading-tight">
                                                                        <Dna size={20} className="mb-0.5 drop-shadow-md group-hover:scale-110 transition-transform" />
                                                                        <div className="flex flex-col items-center">
                                                                            <span className="text-[8px] opacity-80 font-medium">路徑B</span>
                                                                            <span className="text-[10px] tracking-tighter">LV{pLevels.b}→{pLevels.b + 1}</span>
                                                                        </div>
                                                                    </button>
