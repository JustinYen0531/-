                                            ...
                                            <div className="flex gap-2 justify-center items-start w-full px-4 py-2 overflow-visible">
                                                ...
                                                <div className="flex flex-col items-center gap-1">
                                                    <button
                                                        ...
                                                        className={`w-[82px] h-[74px] rounded flex flex-col items-center justify-center gap-1 transition-all relative font-bold border-2 ${targetMode === 'move' && !endTurnConfirm && (!helpers.getUnit(gameState.selectedUnitId)?.status.isStealthed)
                                                ...
                                                {(() => {
                                                    ...
                                                    if (unit.type === UnitType.GENERAL) {
                                                        ...
                                                        // Ghost Steps (Level B2 only)
                                                        // Note: B3-1 becomes passive stealth (no button needed?), B3-2 loses it?
                                                        // Valid logic based on description: Only Level 2 has Active Stealth.
                                                        if (rngLevelB === 2) {
                                                            buttons.push(
                                                                <div key="ghost_steps" className="flex flex-col items-center gap-1">
                                                                    <button
                                                                        ...
                                                                        className={`w-[82px] h-[74px] rounded flex flex-col items-center justify-center gap-1 transition-all relative font-bold border-2 ${unit.status.isStealthed
                                                                            ? 'bg-slate-600 border-slate-400 shadow-lg shadow-slate-500/50 text-white'
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <Ghost size={28} />
                                                                        <span className="text-xs">幽靈步伐</span>
                                                                    </button>
                                                                    <div className="bg-slate-800 rounded px-2 py-1 flex items-center gap-1 text-xs font-bold text-white">⚡ {unit.status.isStealthed ? 0 : 3}</div>
                                                                </div>
                                                            );
                                                        }
                                                        if (unit.carriedMine) {
