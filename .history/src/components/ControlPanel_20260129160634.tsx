                                                    ...
                                                    if (canTeleport) {
                                                        buttons.push(
                                                            <div key="teleport" className="flex flex-col items-center gap-1">
                                                                ...
                                                                <div className="bg-slate-800 rounded px-2 py-1 flex items-center gap-1 text-xs font-bold text-white">⚡ {helpers.getDisplayCost(unit, (rangerLevelA === 3 && rangerVariantA === 2) ? 4 : 0, gameState, 'teleport')}</div>
                                                            </div>
                                                        );
                                                    }
                                                    return buttons;
