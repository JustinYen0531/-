                                                    ...
                                                    if (canEvolveA) {
                                                        result.push(
                                                            <div key="evolve_a" className="flex flex-col items-center gap-1">
                                                                <button onClick={() => actions.handleEvolve(unit.type, 'a')} className="relative w-[84px] h-[84px] p-1 rounded flex flex-col items-center justify-center bg-blue-600 hover:bg-blue-500 font-bold border-2 border-blue-400 shadow-[0_0_20px_rgba(37,99,235,0.6)] text-white overflow-hidden transition-all group active:scale-95 leading-tight">
                                                                    {/* Enhanced Particle Background */}
                                                                    <div className="absolute inset-0 pointer-events-none">
                                                                        <div className="absolute top-2 left-3 w-1.5 h-1.5 bg-white rounded-full animate-vfx-star opacity-40"></div>
                                                                        <div className="absolute top-1/2 right-4 w-1 h-1 bg-blue-100 rounded-full animate-vfx-star opacity-60" style={{ animationDelay: '1.2s' }}></div>
                                                                        <div className="absolute bottom-3 left-1/2 w-1.5 h-1.5 bg-white rounded-full animate-vfx-star opacity-50" style={{ animationDelay: '0.5s' }}></div>
                                                                        <div className="absolute inset-0 bg-gradient-to-tr from-white/0 via-white/10 to-white/0 -translate-x-[150%] group-hover:translate-x-[150%] transition-transform duration-1000"></div>
                                                                    </div>

                                                                    <Dna size={28} className="mb-1 drop-shadow-md group-hover:scale-110 transition-transform" />
                                                    ...
                                                    if (canEvolveB) {
                                                        result.push(
                                                            <div key="evolve_b" className="flex flex-col items-center gap-1">
                                                                <button onClick={() => actions.handleEvolve(unit.type, 'b')} className="relative w-[84px] h-[84px] p-1 rounded flex flex-col items-center justify-center bg-orange-600 hover:bg-orange-500 font-bold border-2 border-orange-400 shadow-[0_0_20px_rgba(249,115,22,0.6)] text-white overflow-hidden transition-all group active:scale-95 leading-tight">
                                                                    {/* Enhanced Particle Background */}
                                                                    <div className="absolute inset-0 pointer-events-none">
                                                                        <div className="absolute top-3 right-3 w-1.5 h-1.5 bg-white rounded-full animate-vfx-star opacity-40"></div>
                                                                        <div className="absolute top-1/4 left-5 w-1 h-1 bg-orange-100 rounded-full animate-vfx-star opacity-60" style={{ animationDelay: '0.8s' }}></div>
                                                                        <div className="absolute bottom-4 right-1/2 w-1.5 h-1.5 bg-white rounded-full animate-vfx-star opacity-50" style={{ animationDelay: '1.5s' }}></div>
                                                                        <div className="absolute inset-0 bg-gradient-to-tr from-white/0 via-white/10 to-white/0 -translate-x-[150%] group-hover:translate-x-[150%] transition-transform duration-1000"></div>
                                                                    </div>
