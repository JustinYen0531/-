                    ...
                    <div className="relative z-10 mt-12 flex w-full max-w-5xl flex-col items-center gap-8">
                        ...
                        {latestDeveloperLog && (
                            <button
                                ...
                                className="w-full max-w-xl rounded-2xl border border-cyan-400/40 bg-slate-900/90 px-5 py-3 text-center shadow-xl shadow-cyan-500/10 transition-all hover:border-cyan-300 hover:scale-[1.01] hover:shadow-cyan-500/20"
                            >
                                <div className="flex flex-col items-center gap-2">
                                    <div className="flex items-center gap-3 w-full justify-center">
                                        <div className="flex items-center gap-1.5 text-cyan-200/90 bg-cyan-500/10 px-2 py-0.5 rounded-full border border-cyan-500/30">
                                            <Info size={12} />
                                            <span className="text-[9px] font-black tracking-[0.1em] uppercase">{uiText.latestArticle}</span>
                                        </div>
                                        <div className="text-[10px] font-mono text-cyan-400/70 font-bold">{latestDeveloperLog.dateLabel}</div>
                                    </div>
                                    <h3 className="text-lg font-black text-white truncate w-full max-w-[90%]">{latestDeveloperLog.title}</h3>
                                    <p className="text-xs text-slate-300 leading-snug line-clamp-1 opacity-80">
