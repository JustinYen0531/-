...
import {
    ...
    Cpu, Cloud, Snowflake, Share2, Radiation, Ghost, Scan, Heart, Hand, Magnet, Brain
} from 'lucide-react';
import {
                                                        ...
                                                        if (defLevelB >= 2) {
                                                            ...
                                                            buttons.push(
                                                                <div key="move_mine" className="flex flex-col items-center gap-1">
                                                                    <button onClick={() => handleSetTargetMode('move_mine_start')} className={`w-[82px] h-[74px] rounded flex flex-col items-center justify-center gap-1 transition-all relative font-bold border-2 ${(targetMode === 'move_mine_start' || targetMode === 'move_mine_end') && !endTurnConfirm ? 'bg-rose-600 shadow-lg shadow-rose-500/50 scale-105 border-rose-400 text-white font-bold' : 'bg-rose-900/40 hover:bg-rose-800/60 border-rose-800/50 text-rose-100/70'}`}>
