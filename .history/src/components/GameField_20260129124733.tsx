        ...
        >
            ...
            <style>{`
                ...
                @keyframes vfx-ice {
                    ...
                    20% { opacity: 1; }
                    100% { transform: scale(1.8) rotate(135deg); opacity: 0; }
                }
                @keyframes vfx-chain-pulse {
                    0% { transform: scale(0.1); opacity: 1; border-width: 12px; }
                    15% { transform: scale(1); opacity: 1; border-width: 8px; }
                ...
                .animate-vfx-ice { animation: vfx-ice 0.8s ease-out forwards; }
                .animate-vfx-chain-pulse { animation: vfx-chain-pulse 0.9s cubic-bezier(0.1, 1, 0.3, 1) forwards; }
                .animate-vfx-chain-core { animation: vfx-chain-core 0.7s ease-out forwards; }
            `}</style>
        </div>
    );
};
