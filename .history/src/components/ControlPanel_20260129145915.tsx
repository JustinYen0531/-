                                ...
                                <div className="flex-1 flex flex-col justify-center w-full">
                                    <div className="w-full flex flex-col justify-center gap-2 items-center relative min-w-[150px]">
                                        {isThinking ? (
                                            ...
                                            <div className="flex-1 flex flex-col justify-center items-center w-full gap-2 py-2">
                                                {/* Dedicated Special Action Panel (For Mine Types) */}
                                                {targetMode === 'place_mine' && helpers.getUnit(gameState.selectedUnitId)?.type === UnitType.MAKER && (
                                                    <div className="flex gap-2 p-2 bg-slate-900/60 border border-purple-500/50 rounded-lg shadow-xl animate-in fade-in slide-in-from-bottom-2">
                                                        {[MineType.NORMAL, MineType.SLOW, MineType.SMOKE, MineType.CHAIN, MineType.NUKE].map(type => {
                                                            ...
                                                            return (
                                                                <button
                                                                    ...
                                                                    className={`p-2 rounded border-2 transition-all flex flex-col items-center gap-1 min-w-[54px] ${selectedMineType === type
                                                                        ? 'bg-purple-600 border-white shadow-lg ring-2 ring-purple-400/50'
                                                ...
                                                {/* Action scrolling row */}
                                                <div className="flex gap-2 justify-center items-start w-full overflow-x-auto scrollbar-hide px-4">
                                        ...
                                        {(() => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className="w-full px-6 py-3 rounded flex flex-col items-center justify-center gap-2 transition-all bg-indigo-600 hover:bg-indigo-500 font-bold border-2 border-indigo-500 text-indigo-200 shadow-lg"
                                                >
                                                    <ArrowRight size={20} />
