...
import {
    X, ChevronLeft, ChevronRight, Crown, Bomb, Eye, Zap, Target, Shield,
    Footprints, Dna, Flag, Building2, Timer, Coins, Users, Swords, Sparkles
} from '../icons';
...
const TUTORIAL_STEPS: TutorialStep[] = [
    // 概念介紹
    {
        ...
        titleKey: 'Welcome to Mine Chess',
        titleZh: '歡迎來到地雷棋',
        contentKey: `Mine Chess is a 2-player strategic turn-based game that combines classic Minesweeper mechanics with Capture-The-Flag gameplay.

Your goal: Capture the enemy flag and bring it back to your base!

The unique twist? Mines are not just obstacles — they are your weapons.`,
        contentZh: `地雷棋是一款雙人回合制策略遊戲，將經典踩地雷與奪旗玩法完美融合。
...
獨特之處？地雷不再只是障礙——它是你的武器。`,
    ...
    // 職業介紹
    {
        ...
        titleKey: 'Your Squad: 5 Unique Units',
        titleZh: '你的小隊：5 種特化職業',
        contentKey: `Each player controls a squad of 5 specialized units:

👑 General — The only unit that can attack & carry the flag
...
Each unit has unique abilities. Master them all!`,
...
每個職業都有獨特能力，掌握它們吧！`,
    ...
    // 能量系統
    {
        ...
        titleKey: 'Energy Economy',
        titleZh: '能量經濟系統',
        contentKey: `Energy is the lifeblood of the game. Every action costs energy:
...
精打細算：激進推進會迅速耗盡，但過度保守可能錯失戰機！`,
    ...
    // 地雷系統
    {
        ...
        titleKey: 'Mine Types',
        titleZh: '地雷種類',
        contentKey: `Mines are your tactical arsenal. Through evolution, unlock special types:
...
場上最多放置 5 顆地雷。善用它們來控制領土！`,
    ...
    // 偵測系統
    {
        ...
        titleKey: 'Mine Detection',
        titleZh: '地雷偵測',
        contentKey: `Enemy mines are hidden! Use your Sweeper to detect them:
...
資訊就是力量。行軍前先偵查！`,
    ...
    // 進化系統
    {
        ...
        titleKey: 'Evolution System',
        titleZh: '進化系統',
        contentKey: `Each unit has 2 evolution paths (A & B), each with 3 tiers:
...
根據戰場狀況調整你的 Build！`,
    ...
    // 回合結構
    {
        ...
        titleKey: 'Turn Structure',
        titleZh: '回合結構',
        contentKey: `Each round has 3 phases:
...
時間壓力創造緊張感。快速思考，但別慌張！`,
    ...
    // 奪旗目標
    {
        ...
        titleKey: 'Capture The Flag',
        titleZh: '奪旗目標',
        contentKey: `The victory condition: Capture enemy flag & bring it to YOUR base!

🚩 Only General can carry the flag (unless evolved)
⚠️ Carrying the flag increases move cost significantly
📍 If the carrier dies, the flag drops at that location
🛡️ Flag aura (evolution) can heal nearby allies or damage enemies

The capture is just the beginning — the escort is the real challenge!`,
        contentZh: `勝利條件：奪取敵方旗幟並帶回己方基地！

🚩 只有將軍能搬旗 (除非進化解鎖)
⚠️ 搬旗時移動成本大幅增加
📍 持旗者陣亡後，旗幟會掉落在該位置
🛡️ 旗幟光環 (進化) 可治癒友軍或傷害敵人
...
奪旗只是開始 — 護送才是真正的挑戰！`,
    ...
    // 建築系統
    {
        ...
        titleKey: 'Building System',
        titleZh: '建築系統',
        contentKey: `Unlock buildings through evolution to control the battlefield:
...
策略性佈置贏得勝利！`,
    ...
    // 最終提示
    {
        ...
        titleKey: 'Pro Tips',
        titleZh: '進階技巧',
        contentKey: `Ready to dominate? Keep these in mind:
...
🎯 Protect Your Carrier — The flag escort is the most vulnerable moment.
                    ...
                    <div className="p-8 pt-10">
                        ...
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <h2 className="text-3xl font-black text-white">
                                {isZh ? step.titleZh : step.titleKey}
                            </h2>
                        </div>
                        ...
                        <div className="bg-slate-900/50 rounded-xl p-6 border border-slate-700/30 min-h-[280px]">
                            <p className="text-slate-200 whitespace-pre-line leading-relaxed text-lg">
                                {isZh ? step.contentZh : step.contentKey}
                            </p>
                        </div>
