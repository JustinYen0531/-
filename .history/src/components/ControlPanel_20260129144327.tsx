                                ...
                                <div className="flex-1 flex flex-col justify-center w-full">
                                    <div className="w-full flex flex-col justify-center gap-2 items-center relative min-w-[150px]">
                                        {isThinking ? (
                                            ...
                                            <div className="flex gap-2 justify-center items-start w-full max-w-full overflow-hidden">
                                                ...
                                                {/* Evolution Buttons - Compact container with scroll */}
                                                <div className="flex-1 min-w-0 flex items-start">
                                                    {(() => {
                                                            ...
                                                            if (pLevels.a === 2) {
                                                                ...
                                                                variants.forEach(v => {
                                                                    result.push(
                                                                        <div key={`evolve_a_${v.id}`} className="flex flex-col items-center gap-1">
                                                                            <button onClick={() => actions.handleEvolve(unit.type, 'a', v.id)} className={`relative w-[74px] h-[74px] p-1 rounded flex flex-col items-center justify-center ${v.color} font-bold border-2 text-white overflow-hidden transition-all group active:scale-95 leading-tight`}>
                                                                                <Dna size={24} className="mb-0.5 drop-shadow-md group-hover:scale-110 transition-transform" />
                                                                ...
                                                                result.push(
                                                                    <div key="evolve_a" className="flex flex-col items-center gap-1">
                                                                        <button onClick={() => actions.handleEvolve(unit.type, 'a')} className="relative w-[74px] h-[74px] p-1 rounded flex flex-col items-center justify-center bg-blue-600 hover:bg-blue-500 font-bold border-2 border-blue-400 shadow-[0_0_20px_rgba(37,99,235,0.6)] text-white overflow-hidden transition-all group active:scale-95 leading-tight">
                                                                            <Dna size={24} className="mb-0.5 drop-shadow-md group-hover:scale-110 transition-transform" />
                                                                            <div className="flex flex-col items-center">
                                                            ...
                                                            if (pLevels.b === 2) {
                                                                ...
                                                                variants.forEach(v => {
                                                                    result.push(
                                                                        <div key={`evolve_b_${v.id}`} className="flex flex-col items-center gap-1">
                                                                            <button onClick={() => actions.handleEvolve(unit.type, 'b', v.id)} className={`relative w-[74px] h-[74px] p-1 rounded flex flex-col items-center justify-center ${v.color} font-bold border-2 text-white overflow-hidden transition-all group active:scale-95 leading-tight`}>
                                                                                <Dna size={24} className="mb-0.5 drop-shadow-md group-hover:scale-110 transition-transform" />
                                                                                <div className="flex flex-col items-center">
                                                                ...
                                                                result.push(
                                                                    <div key="evolve_b" className="flex flex-col items-center gap-1">
                                                                        <button onClick={() => actions.handleEvolve(unit.type, 'b')} className="relative w-[74px] h-[74px] p-1 rounded flex flex-col items-center justify-center bg-orange-600 hover:bg-orange-500 font-bold border-2 border-orange-400 shadow-[0_0_20px_rgba(249,115,22,0.6)] text-white overflow-hidden transition-all group active:scale-95 leading-tight">
                                                                            <Dna size={24} className="mb-0.5 drop-shadow-md group-hover:scale-110 transition-transform" />
                                                                            <div className="flex flex-col items-center">
                                                        ...
                                                        // Add scrollable wrapper for evolution buttons
                                                        if (result.length === 0) return null;
                                                        return (
                                                            <div className="flex flex-nowrap gap-2 overflow-x-auto pb-2 px-1 scrollbar-hide mask-fade-right max-w-full">
                                                                {result}
                                                            </div>
                                                        );
                                                    })()}
