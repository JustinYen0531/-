    ...
    if (building.type === 'tower') {
      return (
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-20 overflow-visible">
          {/* Effect Range Indicator - Unique Dotted Style for Tower */}
          <div className="building-range-indicator" style={{ borderColor: `${accentColor}50`, borderStyle: 'dotted', borderWidth: '3px' }} />
