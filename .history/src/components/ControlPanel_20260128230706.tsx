...
const ControlPanel: React.FC<ControlPanelProps> = ({
    ...
    // Factory button flash state for visual feedback
    ...
    // Reset factory flash after animation
    React.useEffect(() => {
        if (factoryButtonFlash) {
            const timer = setTimeout(() => setFactoryButtonFlash(false), 300);
                                                    ...
                                                    if (canPlaceFactory) {
                                                        ...
                                                        buttons.push(
                                                            <div key="place_factory" className="flex flex-col items-center gap-1">
                                                                <button
                                                                    onClick={() => handleSetTargetMode('place_factory')}
                                                                    className={`w-[74px] h-[74px] p-1 rounded flex flex-col items-center justify-center gap-1 transition-all relative font-bold border-2 ${targetMode === 'place_factory' && !endTurnConfirm
                                                                        ? 'bg-purple-600 shadow-lg shadow-purple-500/50 scale-105 border-purple-400'
