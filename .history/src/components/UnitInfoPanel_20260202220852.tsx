        ...
        <div className="flex-[7] flex flex-col border-l-2 border-white/30 px-4 items-center h-full justify-center bg-slate-800/30">
            ...
            <div className="flex gap-4 justify-center w-full">
                ...
                {player.unitDisplayOrder.map((unitId, index) => {
                    ...
                    // Non-current-turn units in action phase should be dimmed and not clickable
                    const isNotCurrentTurn = !isPlacement && gameState.phase === 'action' && index !== currentActionIndex && !u.hasActedThisRound && !u.isDead;

                    return (
                        <div key={u.id} className="flex flex-col items-center gap-1">
                            <button
                                disabled={u.isDead || u.hasActedThisRound || isNotCurrentTurn}
                                ...
                                className={`
                                    ...
                                    ${isNotCurrentTurn && !isDragging && !isDragOver ? 'opacity-40 brightness-75' : ''}
