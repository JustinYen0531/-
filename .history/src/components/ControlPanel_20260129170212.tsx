                                                ...
                                                <div className="flex flex-col items-center gap-1">
                                                    <button
                                                        onClick={() => {
                                                            ...
                                                            if (u?.status.isStealthed) actions.handleStealth(u.id);
                                                    ...
                                                    <div className="bg-slate-800 rounded px-2 py-1 flex items-center gap-1 text-xs font-bold text-white">
                                                        ...
                                                        {(() => {
                                                            const u = helpers.getUnit(gameState.selectedUnitId);
                                                            if (!u) return 0;
                                                            // Always show normal move cost (2) even if stealthed
                                                            const costUnit = u.status.isStealthed ? { ...u, status: { ...u.status, isStealthed: false } } : u;
                                                            return helpers.getDisplayCost(costUnit, 2, gameState, 'move');
                                                        })()}
                                                    </div>
                                                    <span>{(() => {
                                                ...
                                                if (rngLevelB === 2) {
                                                    buttons.push(
                                                        <div key="ghost_steps" className="flex flex-col items-center gap-1">
                                                            ...
                                                            <div className="bg-slate-800 rounded px-2 py-1 flex items-center gap-1 text-xs font-bold text-white">⚡ 3</div>
                                                        </div>
                                                    );
                                                }
                                                if (unit.carriedMine) {
