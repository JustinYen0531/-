                                                    ...
                                                    if (unit.type === UnitType.GENERAL) {
                                                        ...
                                                        buttons.push(
                                                            <div key="scan" className="flex flex-col items-center gap-1">
                                                                ...
                                                                <div className="bg-slate-800 rounded px-2 py-1 flex items-center gap-1 text-xs font-bold text-white">⚡ {helpers.getDisplayCost(unit, swpLevelA >= 1 ? 5 : 8)}</div>
                                                            </div>
                                                        );
                                                        ...
                                                        if (swpLevelB >= 1) {
                                                            ...
                                                            buttons.push(
                                                                <div key="sensor_scan" className="flex flex-col items-center gap-1">
                                                                    ...
                                                                    <div className="bg-slate-800 rounded px-2 py-1 flex items-center gap-1 text-xs font-bold text-white">⚡ {helpers.getDisplayCost(unit, finalCost)}</div>
                                                                </div>
                                                            );
                                                        }
