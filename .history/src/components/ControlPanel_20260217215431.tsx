...
const ControlPanel: React.FC<ControlPanelProps> = ({
    gameState, setGameState, targetMode, setTargetMode, selectedMineType, setSelectedMineType,
    ...
    handlePlaceFactoryAction, handlePlaceHubAction, handleTeleportToHubAction, handleStealthAction,
    handleRangerAction, swapUnits, isLocalPlayerTurn
}) => {
    ...
    // Flag to disable all interactive elements when it's not the local player's turn or during AI turn
    const isInteractionDisabled = isAiTurnLocked || !isLocalPlayerTurn;
