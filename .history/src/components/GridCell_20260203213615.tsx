        ...
        unit && !unit.isDead && (
          ...
          >
            ...
            <div className="w-full h-full relative flex items-center justify-center animate-unit-breathe font-bold">
              ...
              {/* Limbs - Hands */}
              <div className={`little-person-limb -left-1.5 top-[14px] ${unit?.owner === PlayerID.P1 ? 'bg-cyan-500' : 'bg-red-500'}`} />
              <div className={`little-person-limb -right-1.5 top-[14px] ${unit?.owner === PlayerID.P1 ? 'bg-cyan-500' : 'bg-red-500'}`} />

              {/* Limbs - Feet */}
              <div className={`little-person-limb left-1.5 -bottom-1.5 ${unit?.owner === PlayerID.P1 ? 'bg-cyan-500' : 'bg-red-500'}`} />
              <div className={`little-person-limb right-1.5 -bottom-1.5 ${unit?.owner === PlayerID.P1 ? 'bg-cyan-500' : 'bg-red-500'}`} />
