...
const GridCell: React.FC<GridCellProps> = ({
  ...
  if (selectedUnit && targetMode) {
    ...
    } else if ((targetMode === 'scan' || targetMode === 'sensor_scan') && chebyshevDist <= 1) {
      isInActionRange = true;
      actionRangeColor = targetMode === 'sensor_scan' ? 'border-cyan-400 shadow-[0_0_10px_rgba(34,211,238,0.6)]' : 'border-emerald-400 shadow-[0_0_10px_rgba(16,185,129,0.6)]';
