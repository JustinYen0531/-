                                                    ...
                                                    if (unit.type === UnitType.GENERAL) {
                                                        ...
                                                        buttons.push(
                                                            <div key="scan" className="flex flex-col items-center gap-1">
                                                                ...
                                                                <div className="bg-slate-800 rounded px-2 py-1 flex items-center gap-1 text-xs font-bold text-white"><Zap size={12} className="text-yellow-400" /> {helpers.getDisplayCost(unit, swpLevelA >= 1 ? 5 : 8, gameState, 'scan')}</div>
                                                            </div>
                                                        );
                                                    ...
                                                    return (
                                                        <>
                                                            ...
                                                            <button
                                                                ...
                                                                className={`w-full px-6 py-3 rounded flex items-center justify-center relative transition-all font-bold border-2 shadow-lg ${canAffordSkip
                                                            ...
                                                            >
                                                                ...
                                                                <span className="absolute right-4 flex items-center gap-1 bg-slate-800/60 px-2 py-0.5 rounded text-xs">
