                                            ...
                                            <div className="flex gap-2 justify-center flex-wrap">
                                                <div className="flex flex-col items-center gap-1">
                                                    <button
                                                        ...
                                                        className={`w-[74px] h-[74px] p-1 rounded flex flex-col items-center justify-center gap-1 transition-all relative font-bold border-2 ${targetMode === 'move' && !endTurnConfirm
                                                ...
                                                {/* Evolution Buttons - Moved to the right of End Turn */}
                                                {(() => {
                                                    const unit = helpers.getUnit(gameState.selectedUnitId);
                                                    if (!unit || unit.owner !== gameState.currentPlayer) return null;
                                                    ...
                                                    if (canEvolveA) {
                                                        result.push(
                                                            <div key="evolve_a" className="flex flex-col items-center gap-1">
                                                                <button onClick={() => actions.handleEvolve(unit.type, 'a')} className="relative w-[80px] h-[80px] p-1 rounded flex flex-col items-center justify-center bg-blue-600 hover:bg-blue-500 font-bold border-2 border-blue-400 shadow-[0_0_15px_rgba(37,99,235,0.5)] text-white overflow-hidden transition-all group">
                                                                    <div className="absolute inset-0 pointer-events-none">
                                                                        <div className="absolute top-1 left-2 w-1 h-1 bg-white rounded-full animate-ping opacity-70"></div>
                                                                        <div className="absolute bottom-2 right-3 w-1.5 h-1.5 bg-blue-200 rounded-full animate-pulse opacity-60" style={{ animationDelay: '0.5s' }}></div>
                                                                        <div className="absolute top-4 right-2 w-1 h-1 bg-white rounded-full animate-bounce opacity-50" style={{ animationDuration: '3s' }}></div>
                                                                    ...
                                                                    <Dna size={22} className="mb-0.5" />
                                                                    <div className="flex flex-col items-center leading-[1.1]">
                                                                        <span className="text-[10px] opacity-90 font-medium">路徑A</span>
                                                                        <span className="text-xs tracking-wider">{pLevels.a}→{pLevels.a + 1}</span>
                                                                    </div>
                                                                </button>
                                                    ...
                                                    if (canEvolveB) {
                                                        result.push(
                                                            <div key="evolve_b" className="flex flex-col items-center gap-1">
                                                                <button onClick={() => actions.handleEvolve(unit.type, 'b')} className="relative w-[80px] h-[80px] p-1 rounded flex flex-col items-center justify-center bg-orange-600 hover:bg-orange-500 font-bold border-2 border-orange-400 shadow-[0_0_15px_rgba(249,115,22,0.5)] text-white overflow-hidden transition-all group">
                                                                    <div className="absolute inset-0 pointer-events-none">
                                                                        <div className="absolute top-2 right-2 w-1 h-1 bg-white rounded-full animate-ping opacity-70" style={{ animationDelay: '0.2s' }}></div>
                                                                        <div className="absolute bottom-3 left-3 w-1.5 h-1.5 bg-orange-200 rounded-full animate-pulse opacity-60" style={{ animationDelay: '0.7s' }}></div>
                                                                        <div className="absolute top-1 left-4 w-1 h-1 bg-white rounded-full animate-bounce opacity-50" style={{ animationDuration: '2.5s' }}></div>
                                                                        <div className="absolute inset-0 bg-gradient-to-tr from-white/0 via-white/20 to-white/0 -translate-x-[100%] group-hover:translate-x-[100%] transition-transform duration-700"></div>
                                                                    </div>
                                                                    <Dna size={22} className="mb-0.5" />
                                                                    <div className="flex flex-col items-center leading-[1.1]">
                                                                        <span className="text-[10px] opacity-90 font-medium">路徑B</span>
                                                                        <span className="text-xs tracking-wider">{pLevels.b}→{pLevels.b + 1}</span>
                                                                    </div>
                                                                </button>
