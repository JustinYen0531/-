                                ...
                                <div className="flex-1 flex flex-col justify-center w-full">
                                    <div className="w-full flex flex-col justify-center gap-2 items-center relative min-w-[150px]">
                                        {isThinking ? (
                                            ...
                                            <div className="flex gap-2 justify-center items-start w-full overflow-x-auto scrollbar-hide px-4 py-2">
                                                ...
                                                {(() => {
                                                    ...
                                                    if (unit.type === UnitType.GENERAL) {
                                                        ...
                                                        // Place Mine button (Restoring the popup menu with visual fixes)
                                                        buttons.push(
                                                            <div key="place_mine_group" className="flex flex-col items-center gap-1 relative">
                                                                {targetMode === 'place_mine' && (
                                                                    <div className="absolute bottom-[80px] left-1/2 -translate-x-1/2 bg-slate-900/95 border-2 border-purple-500 rounded-lg p-1 flex gap-1 shadow-[0_0_15px_rgba(168,85,247,0.4)] z-[100] min-w-max backdrop-blur-sm">
                                                                        {[MineType.NORMAL, MineType.SLOW, MineType.SMOKE, MineType.CHAIN, MineType.NUKE].map(type => {
                                                                            ...
                                                                            return (
                                                                                <button
                                                                                    ...
                                                                                    className={`p-1.5 rounded border transition-all flex flex-col items-center gap-0.5 min-w-[40px] ${selectedMineType === type ? 'bg-purple-600/40 border-purple-400 scale-105 shadow-[0_0_8px_rgba(168,85,247,0.5)]' : 'bg-slate-800/80 border-slate-700 hover:border-purple-400'}`}
                                                                                >
