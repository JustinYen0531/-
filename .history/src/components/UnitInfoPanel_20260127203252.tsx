...
import { PlayerID, GameState, Unit } from '../types';
import { Skull, Swords, Zap, Move, Shield, Info } from '../icons';
...
const UnitInfoPanel: React.FC<UnitInfoPanelProps> = ({ gameState, t, onUnitClick }) => {
