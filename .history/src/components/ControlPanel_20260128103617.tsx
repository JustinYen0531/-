                                                    ...
                                                    if (canPlaceFactory) {
                                                        ...
                                                        buttons.push(
                                                            <div key="place_factory" className="flex flex-col items-center gap-1">
                                                                <button onClick={() => handlePlaceFactoryAction(unit, unit.r, unit.c)} className="px-3 py-2 rounded flex flex-col items-center gap-1 min-w-[60px] transition-all relative font-bold border-2 bg-slate-700 hover:bg-slate-600 border-slate-600 text-slate-300">
                                                    ...
                                                    if (canPlaceHub) {
                                                        buttons.push(
                                                            <div key="place_hub" className="flex flex-col items-center gap-1">
                                                                <button onClick={() => handlePlaceHubAction(unit, unit.r, unit.c)} className="px-3 py-2 rounded flex flex-col items-center gap-1 min-w-[60px] transition-all relative font-bold border-2 bg-slate-700 hover:bg-slate-600 border-slate-600 text-slate-300">
                                                    ...
                                                    if (unit.type === UnitType.GENERAL) {
                                                        ...
                                                        buttons.push(
                                                            <div key="place_mine_group" className="flex flex-col items-center gap-1 relative">
                                                                ...
                                                                <button
                                                                    ...
                                                                    className={`px-3 py-2 rounded flex flex-col items-center gap-1 min-w-[72px] transition-all relative font-bold border-2 ${targetMode === 'place_mine' ? 'bg-purple-600 border-white ring-2 ring-purple-400 ring-offset-2 ring-offset-slate-900' : 'bg-slate-700 hover:bg-slate-600 border-slate-600'}`}
                                                                >
                                                        ...
                                                        if (!unit.carriedMine && mineInRange) {
                                                            buttons.push(
                                                                <div key="pickup_mine" className="flex flex-col items-center gap-1">
                                                                    <button onClick={() => handleRangerAction('pickup')} className="px-3 py-2 rounded flex flex-col items-center gap-1 min-w-[60px] transition-all relative font-bold border-2 bg-slate-700 hover:bg-slate-600 border-slate-600 text-slate-300">
                                                        ...
                                                        if (unit.carriedMine) {
                                                            buttons.push(
                                                                <div key="throw_mine" className="flex flex-col items-center gap-1">
                                                                    <button onClick={() => setTargetMode('throw_mine')} className="px-3 py-2 rounded flex flex-col items-center gap-1 min-w-[60px] transition-all relative font-bold border-2 bg-slate-700 hover:bg-slate-600 border-slate-600 text-slate-300">
                                                            ...
                                                            buttons.push(
                                                                <div key="drop_mine" className="flex flex-col items-center gap-1">
                                                                    <button onClick={() => handleRangerAction('drop')} className="px-3 py-2 rounded flex flex-col items-center gap-1 min-w-[60px] transition-all relative font-bold border-2 bg-yellow-600/70 hover:bg-yellow-600 border-yellow-500 text-white">
                                                        ...
                                                        buttons.push(
                                                            <div key="disarm" className="flex flex-col items-center gap-1">
                                                                <button onClick={() => setTargetMode('disarm')} className={`px-3 py-2 rounded flex flex-col items-center gap-1 min-w-[60px] transition-all relative font-bold border-2 ${targetMode === 'disarm' ? 'bg-cyan-600 border-cyan-400' : 'bg-slate-700 hover:bg-slate-600 border-slate-600'}`}>
                                                        ...
                                                        if (!unit.hasFlag && isAtFlag) {
                                                            buttons.push(
                                                                <div key="pickup_flag" className="flex flex-col items-center gap-1">
                                                                    <button onClick={actions.handlePickupFlag} className="px-3 py-2 rounded flex flex-col items-center gap-1 min-w-[60px] transition-all relative bg-yellow-600/70 hover:bg-yellow-600 border-2 border-yellow-500 cursor-pointer text-white">
                                                        ...
                                                        if (unit.hasFlag) {
                                                            buttons.push(
                                                                <div key="drop_flag" className="flex flex-col items-center gap-1">
                                                                    <button onClick={actions.handleDropFlag} className="px-3 py-2 rounded flex flex-col items-center gap-1 min-w-[60px] transition-all relative bg-yellow-600/70 hover:bg-yellow-600 border-2 border-yellow-500 shadow-lg shadow-yellow-500/50 text-white">
