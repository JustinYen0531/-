                                        ...
                                        {isThinking ? (
                                            ...
                                            <div className="flex gap-2 justify-center items-start w-full px-4 py-2 overflow-visible">
                                                ...
                                                <div className="flex flex-col items-center gap-1">
                                                    ...
                                                    {/* Energy cost display for healing on end turn */}
                                                    <div className="bg-emerald-600/80 rounded px-2 py-1 flex items-center gap-1 text-xs font-bold text-white">+3 HP</div>
                                                </div>

                                                {/* Skip Turn - Don't mark unit as acted, costs escalating energy */}
                                                {(() => {
                                                    ...
                                                    return (
                                                        <div className="flex flex-col items-center gap-1">
                                                            <button
                                                                ...
                                                                className={`w-[82px] h-[74px] rounded flex flex-col items-center justify-center gap-1 transition-all relative font-bold border-2 ${canAffordSkip
                                                                        ? 'bg-amber-700 hover:bg-amber-600 border-amber-500 text-amber-100 hover:border-amber-400'
                                                                        : 'bg-slate-800 border-slate-700 text-slate-500 cursor-not-allowed opacity-50'
                                                                    }`}
                                                            >
                                                                <Play size={28} className="rotate-90" />
                                                                <span className="text-xs">{t('skip_turn')}</span>
                                                            </button>
                                                            <div className={`rounded px-2 py-1 flex items-center gap-1 text-xs font-bold ${canAffordSkip ? 'bg-amber-800' : 'bg-slate-800'} text-white`}>
