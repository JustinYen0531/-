...
import { FlaskConical, Cpu, DoorOpen, Swords, Globe, X, ArrowRight, HelpCircle, Crown, Bomb, Users, Volume2, VolumeX } from '../icons';
    ...
    if (view === 'lobby') {
        return (
            <div className="flex flex-col items-center justify-center h-full bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950 p-4 relative w-full absolute inset-0 z-50 overflow-hidden">
                ...
                {!roomId ? (
                    <div className="relative z-10 mt-8 flex flex-wrap items-stretch justify-center gap-4">
                        <button
