                                                        ...
                                                        buttons.push(
                                                            <div key="place_mine_group" className="w-[82px] flex flex-col items-center gap-1 relative overflow-visible">
                                                                {targetMode === 'place_mine' && (
                                                                    <div className="absolute bottom-[95px] left-1/2 -translate-x-1/2 bg-slate-900 border-2 border-purple-500 rounded-lg p-1.5 flex gap-1.5 shadow-[0_0_20px_rgba(168,85,247,0.6)] z-[100] min-w-max animate-in fade-in slide-in-from-bottom-2">
