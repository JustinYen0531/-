                    ...
                    <div className="flex-[4] flex flex-col border-l-2 border-white/30 px-4 items-center justify-between h-full py-1 bg-slate-800/30">
                        {isPlacement ? (
                            ...
                            <div className="relative w-full h-full flex flex-col items-center">
                                {/* Fixed Mine Selection Popup (Covers Action Text) */}
                                {targetMode === 'place_mine' && selectedUnit?.type === UnitType.MAKER && (
                                    <div className="absolute top-4 left-1/2 -translate-x-1/2 bg-slate-900 border-2 border-purple-500 rounded-lg p-1.5 flex gap-2 shadow-[0_0_25px_rgba(168,85,247,0.7)] z-[100] min-w-max animate-in fade-in zoom-in-95 duration-200">
                                        {[MineType.NORMAL, MineType.SLOW, MineType.SMOKE, MineType.CHAIN, MineType.NUKE].map(type => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`p-1.5 rounded border-2 transition-all flex flex-col items-center gap-1 min-w-[48px] ${selectedMineType === type ? 'bg-purple-600/60 border-purple-300 scale-105 shadow-[0_0_10px_rgba(168,85,247,0.6)]' : 'bg-slate-800/80 border-slate-700 hover:border-purple-400'}`}
                                                >
                                                    ...
                                                    <span className="text-xs font-black text-white leading-none">
                                                        {helpers.getDisplayCost(selectedUnit, getMineBaseCost(type))}
                                                    </span>
                                                </button>
                                            );
                                        })}
                                            ...
                                            <div className="flex gap-2 justify-center items-start w-full overflow-x-auto scrollbar-hide px-4 py-2">
                                                ...
                                                {(() => {
                                                    ...
                                                    if (unit.type === UnitType.GENERAL) {
                                                        ...
                                                        // Place Mine button (Popup moved to top)
                                                        buttons.push(
