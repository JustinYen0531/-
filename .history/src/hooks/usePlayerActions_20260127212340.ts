...
export const usePlayerActions = ({
    ...
    const handlePlaceMineAction = useCallback((unit: Unit, targetR: number, targetC: number) => {
        ...
        // Use the selected mine type directly. 
        // Logic for restricting mines based on evolution levels should be primarily handled in the UI (ControlPanel),
        // but we keep effectiveMineType here as a final confirmation step.
        const effectiveMineType = selectedMineType;
        ...
        handleActionComplete(unit.id);
    }, [gameStateRef, selectedMineType, addLog, checkEnergyCap, setGameState, setTargetMode, setSelectedMineType, handleActionComplete]);
