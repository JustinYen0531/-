...
export const usePlayerActions = ({
    ...
    const startNewRound = useCallback((prevState: GameState) => {
        ...
        setGameState({
            ...
            smokes: newSmokes,
            movements: [],
            sensorResults: prevState.sensorResults.filter(sr => nextTurn - sr.createdTurn < 2), // Keep sensor results for 2 rounds
            players: {
    ...
    const handleSensorScan = useCallback((unitId: string, r: number, c: number) => {
        ...
        addLog('log_action_sensor_scan', 'move', { r, c }, unit.owner);
        setTargetMode(null);
