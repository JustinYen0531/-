...
export default function App() {
    ...
    const handleStealthAction = (unitId: string) => {
        ...
        const cost = 0; // Toggle is free
        // if (player.energy < cost) ... // Cost is 0
        // if (!checkEnergyCap(unit, player, cost)) ... // Cost is 0

        setGameState(prev => {
            const p = prev.players[unit.owner];
            const updatedUnits = p.units.map(u => u.id === unitId ? {
                ...u,
                // energyUsedThisTurn: u.energyUsedThisTurn + cost, // No cost
              ...
              `}</style>
                    ...
                    <ControlPanel
                        ...
                        helpers={{
                            ...
                            getActionButtonIndex: (action, unit) => unit ? getActionButtonIndex(action, unit, gameState) : -1,
