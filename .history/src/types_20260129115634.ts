...
export interface GameState {
  ...
  vfx: VFXEffect[];
  // === Chronal Overload System ===
  chronalCharges: number;           // 0-10, freeze actions used
  isChronalOverload: boolean;       // true when in penalty state
  chronalOverloadEndTime?: number;  // timestamp when overload ends
}