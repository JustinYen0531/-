        ...
        if (actionType === 'mine') {
            ...
            if (unit.type === UnitType.DEFUSER) {
                if (defLevelB >= 1) {
                    ...
                    inRange = chebyshevDist <= 2;
                } else {
                    // Level 0 : 3x3 Square (Radius 1) PLUS Cardinal 2 Extension (Matches UI)
                    inRange = (chebyshevDist <= 1) || (chebyshevDist === 2 && (dr === 0 || dc === 0));
                }
            } else {
            ...
            inRange = (dr === 0 && dc === 0); // Must be standing on it
        }
