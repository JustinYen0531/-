                            ...
                            <div className="flex-1 flex flex-col overflow-visible relative">
                                ...
                                <div className="w-full px-8 py-3 flex items-center justify-center gap-6 relative z-20">
                                    ...
                                    <div className="flex items-center gap-2 justify-end min-w-[80px]">
                                        <div
                                            className={`transition-opacity ease-in-out ${gameState.isTimeFrozen ? 'opacity-100 duration-100' : 'opacity-0 duration-200'}`}
                                            style={{ transitionDelay: gameState.isTimeFrozen ? '100ms' : '0ms' }}
                                        >
                                            <Snowflake size={18} className="text-cyan-300 animate-spin-slow" />
                                        </div>
                                        <span className={`font-bold text-lg text-right transition-colors duration-150 ${gameState.isTimeFrozen ? 'text-cyan-300' : 'text-white'}`}>
