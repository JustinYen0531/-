    ...
    const renderBidDrawer = () => (
        <>
            <button
                ...
                className="mt-2 px-4 py-1.5 bg-slate-900 border-2 border-yellow-500/60 rounded-lg text-yellow-200 hover:text-yellow-100 hover:bg-slate-800 transition-all shadow-[0_0_12px_rgba(234,179,8,0.25)] flex items-center justify-center gap-1 z-20"
                title={showBidPopup
                        ...
                        {isPlacement ? (
                                ...
                                <div className="w-full h-full flex flex-col items-center justify-center gap-4 px-4">
                                    <div className="flex flex-col items-center gap-3">
                                        ...
                                        <span className="text-lg font-black text-white uppercase tracking-widest animate-pulse drop-shadow-lg">
                                            {t('wait_opponent_setup')}
                                        </span>
                                        <span className="text-xs text-slate-400 font-medium">
                                            {t('wait_opponent_setup_detail')}
                                        </span>
                                    </div>
                                </div>
                            ) : (
                            ...
                            <div className="w-full flex-1 flex flex-col items-center justify-center gap-4 px-4">
                                <div className="flex flex-col items-center gap-3">
                                    ...
                                    <span className="text-lg font-black text-white uppercase tracking-widest animate-pulse drop-shadow-lg">
                                        {t('wait_opponent_action')}
                                    </span>
                                    <span className="text-xs text-slate-400 font-medium">
                                        {t('wait_opponent_action_detail')}
                                    </span>
                                </div>
                            </div>
                        ) : (
